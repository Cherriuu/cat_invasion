...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        score_str = "{:,}".format(rounded_score) # how to insert formatted commas into numbers when converting from a numerical value to a string
    ...
    def prep_cats(self):
        ...
        for cat_number in range (self.stats.cats_left):
            cat = Cat(self.screen, self.ai_settings)
